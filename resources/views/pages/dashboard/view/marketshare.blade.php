...
@section ('content')
    ...
    <div class="headerbar">
        ...
        {{ Form::open(array('url' => 'admin/dashboard/view-market-share','method'=>'POST','files'=>'true','id'=>'marketshare') )}}
    <div class="row">
        <div class="col-md-12">
    ...
    <br>
    <div class="row"><h3 style="padding: 0px 20px;">{{$user_list[$i]->name}}</h3></div>
    <div class="row">
        <div class="col-md-3">
            <div class="table">
                <table>
                    ...
                    <tbody id='scorecardhtml'>
                        ...
                        @forelse($Final_client_marketshare_month[$i] as $row1)
                    ...
                    <tr>
                        ...
                        <td colspan="2" style="text-align: right;">
                            $ {{number_format($final_client_totalspend_month[$i])}}
                        </td>
                    </tr>
                    </tbody>
                </table>
        ...
        <div class="col-md-3">
            <div class="table">
                <table>
                    ...
                    <tbody id='scorecardhtml'>
                    @forelse($Final_client_marketshare_year[$i] as $row1)
                    ...
                    <tr>
                        <td style="background: #93bae987">Total</td>
                        <td colspan="2" style="text-align: right;">
                            $ {{number_format($final_client_totalspend_year[$i])}}
                        </td>
                    </tr>
                    </tbody>
                </table>
    ...
    <script type="text/javascript">
        ...
        var user = <?php echo json_encode($user_list); ?>;
        ...
        for (i = 0; i < user.length; i++) {
            ...
            $.each(month_marketshare[i], function (i1, item) {
            ...
            $.each(year_marketshare[i], function (i1, items) {
