        ...
        <div class="box-center1">
            <div class="add_new_box" style="margin-left: 200px;">
                ...
                <div class="col-md-12 col-lg-12 modal-box" style="margin-top:10px;">
                    ...
                    <h3>Edit Physician Preference</h3>
                    {{ Form::open(array('url' => 'admin/devices/devicesurvey/update/'.$id.'/'.$deviceId,'method'=>'PUT','files'=>true)) }}
                    <div class="content-area clearfix" style="padding:30px 0px 30px 0px;">
                        <div class="col-md-12 col-lg-12 modal-box" align="center">
                            ...
                            <div class="input1">
                                ...
                                {{ Form::select('clientId',$client_name,$id,array('id'=>'clientname')) }}
                            </div>
                            ...
                            <div class="input1">
                                ...
                                {{Form::select('status', array(''=>'Status','True' => 'Active','False'=>'DeActive'),$status, array('class' => 'name'))}}
                            </div>
                    ...
                    <div class="modal-btn clearfix">
                        {{ Form::submit('UPDATE') }}
                        <a href="{{ URL::to('admin/devices/devicesurvey/remove/'.$id.'/'.$deviceId) }}" onclick="return confirm(' Are you sure you want to delete physician preference?');"
                           style="padding:8px 75px; border-radius:5px; color:#fff; text-decoration:none; background:red;">DELETE</a>
                    </div>
                    {{ Form::close() }}
                </div>
            </div>
