        ...
        <div class="box-center1">
            <div class="add_new_box" style="margin-left: 120px;">
                ...
                <div class="col-md-12 col-lg-12 modal-box" style="margin-top:10px;">
                    <a title="" href="{{ URL::to('admin/devices/view/'.$deviceid) }}#3" class="pull-right">X</a>
                    <ul>
                    ...
                    <h3>Add Contacts</h3>
                    {{ Form::open(array('url' => 'admin/devices/customcontact/store','method'=>'POST','files'=>true)) }}
                    <div class="content-area clearfix" style="padding:30px 0px 30px 0px;">
                        <div class="col-md-12 col-lg-12 modal-box" align="center">
                            ...
                            <div class="input1">
                                ...
                                &nbsp;
                                {{ Form::text('orderNumber','',array('placeholder'=>'Order Phonenumber','readonly'=>'true','id'=>'orderphone'))}}
                            </div>
                            <br>
                            <div class="input1">
                                {{Form::label('label4', 'CC #1 Email')}}
                                {{ Form::text('cc1','',array('placeholder'=>'Email Address','id'=>'cc1'))}}
                                &nbsp; {{ Form::text('cc1Number','',array('placeholder'=>'cc1 Phonenumber','id'=>'cc1Number'))}}
                            </div>
                            <div class="input1">
                                {{Form::label('label5', 'CC #2 Email')}}
                                {{ Form::text('cc2','',array('placeholder'=>'Email Address','id'=>'cc2'))}}
                                &nbsp; {{ Form::text('cc2Number','',array('placeholder'=>'cc2 Phonenumber','id'=>'cc2Number'))}}
                            </div>
                            <div class="input1">
                                {{Form::label('label17', 'CC #3 Email')}}
                                {{ Form::text('cc3','',array('placeholder'=>'Email Address','id'=>'cc3'))}}
                                &nbsp; {{ Form::text('cc3Number','',array('placeholder'=>'cc3 Phonenumber','id'=>'cc3Number'))}}
                            </div>
                            <div class="input1">
                                {{Form::label('label6', 'CC #4 Email')}}
                                {{ Form::text('cc4','',array('placeholder'=>'Email Address','id'=>'cc4'))}}
                                &nbsp; {{ Form::text('cc4Number','',array('placeholder'=>'cc4 Phonenumber','id'=>'cc4Number'))}}
                            </div>
                            <div class="input1">
                                {{Form::label('label7', 'CC #5 Email')}}
                                {{ Form::text('cc5','',array('placeholder'=>'Email Address','id'=>'cc5'))}}
                                &nbsp; {{ Form::text('cc5Number','',array('placeholder'=>'cc5 Phonenumber','id'=>'cc5Number'))}}
                            </div>
                            <div class="input1">
                                {{Form::label('label7', 'CC #6 Email')}}
                                {{ Form::text('cc6','',array('placeholder'=>'Email Address','id'=>'cc6'))}}
                                &nbsp; {{ Form::text('cc6Number','',array('placeholder'=>'cc6 Phonenumber','id'=>'cc6Number'))}}
                            </div>

                            <br>
                            <div class="input1" style="text-align: left;margin-left: -125px;">
                                {{Form::label('label7', 'Subject',array('class'=>'customcc'))}}
                                {{ Form::text('subject','',array('placeholder'=>'Default Subject Line Editable '))}}
                            </div>
                    ...
                    <div class="modal-btn clearfix">
                        {{ Form::submit('SAVE') }}
                        <a href="{{ URL::to('admin/devices/view/'.$deviceid) }}#3"
