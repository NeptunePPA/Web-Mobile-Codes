...
@section ('content')
    ...
    <div class="content-area clearfix" style="margin:0 30%;">
        ...
        <div class="top-links clearfix">
            <ul class="add-links">
                <li>
                    <a title="Edit" href="{{URL::to('admin/devices/serialnumber/editconsignment/'.$serialId)}}" data-toggle="modal"> Edit </a> |
                    {{--<a title="Import" href="#" id="import"> Import </a> |--}}
                    <a title="Export" href="{{URL::to('admin/devices/serialnumber/exportconsignment/'.$serialId)}}" data-toggle="modal">Export</a> |
                    {{--<a title="Remove" href="#" data-toggle="modal" class="remove">Remove</a> |--}}
                    <a title="Bulk" href="{{URL::to('admin/devices/serialnumber/view/'.$serialId)}}" data-toggle="modal" class="remove">Bulk</a>
                </li>
            </ul>
