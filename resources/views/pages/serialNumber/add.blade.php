    ...
    <div class="add_new">
        <div class="add_new_box">
            ...
            <div class="col-md-12 col-lg-12 modal-box">
                <a title="Add Item File" href="{{URL::to('admin/devices/view/'.$deviceid)}}#6" class="pull-right">X</a>
                <h4> Add Serial Number </h4>
                {{ Form::open(array('url' => 'admin/devices/serialnumber/store/'.$deviceid,'method'=>'POST','files'=>'true') )}}
                <ul>
