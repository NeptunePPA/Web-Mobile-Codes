...
@section ('content')
    ...
    <div class="content-area clearfix" style="margin:0 30%;">
        ...
        <div class="top-links clearfix">
            <ul class="add-links">
                <li>
                    <a title="view" href="{{URL::to('admin/devices/serialnumber/consignment/'.$serialId)}}" > View </a> |
        ...
        <div class="table" >
            <table>
                ...
                {{ Form::open(array('url' => 'admin/devices/serialnumber/updateconsignment/'.$serialId,'method'=>'POST','id'=>'detailsform') )}}
