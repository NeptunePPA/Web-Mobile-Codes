...
@section('content')
	...
	<div class="container menu-panel">
		<div class="header">
			<h1><img src="{{ URL::asset('frontend/images/logo.png') }}" style="margin:0;" /></h1>
		</div>
        <ul class="menu-list">
			<li class="col-xs-12 col-sm-12 col-md-12 col-lg-12 changeout" style="width: auto; margin:20px 0">
			<a style="color:#161443; width: auto; font-size: 22px;">
