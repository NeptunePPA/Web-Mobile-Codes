            ...
            <div class="case-details-btn-block">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            <center>
                                <h4 class="rap-case-title">Swap Device</h4>
                                <a href="{{URL::to('repcasetracker/swapdevice/edit/'.$id)}}" class="btn btn-default view-edit-details-btn">Same Device new Serial#</a>
                                <a href="{{URL::to('repcasetracker/swapdevice/new/edit/'.$id)}}" class="btn btn-default view-edit-details-btn">Completely New Device</a>
                                <a href="{{ URL::to('repcasetracker') }}" class="btn btn-danger logout-btn">Cancel</a>
                            </center>
                        </div>
                    </div>
                </div>
