...
(function($){
  $.fn.imageBox = function(options){
    ...
    $(objClicked).on('click', function(){
      ...
      $('#img-preview').html('<img src="'+ _url +'" width="500px" height="220px" class="image-box" style="cursor: move;"></img>')
  ...
  function initHtml(obj){
    ...
    div.append('<div class="modal-dialog">' +
                  '<div class="modal-content">'+
                        ...
                        // '</div>'+
                        '<div style="min-height: 220px;max-height: 500px;" class="modal-body">'+
